...
def search_data():
    ...
    ### Rendering Plot in Html
        ...
        return render_template('output2.html', sentiment=sentiment,name=x,result2=result2,result=result ,image=img_filename)
...
def search():
    ...
    ### Rendering Plot in Html
        ...
        return render_template('output.html',sentiment=sentiment,result2=im,name=x,image=img_filename, resultx=resultx)
